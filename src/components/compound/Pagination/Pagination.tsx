import {PaginationControllerConfig, usePaginationController} from "../../logic/hooks/usePaginationController.ts";
...
type PaginationProps = PaginationControllerConfig & {
...
export const Pagination: FC<PaginationProps> = (props) => {
  ...
  const controller = usePaginationController(controllerConfig)
